...
/**
 * La clase MiTreeMap implementa la interfaz IMap utilizando un TreeMap para
 * almacenar las colecciones de cartas.
 */
public class MiTreeMap implements IMap {
    private Map<String, Carta> coleccionEntera;
    private Map<String, Carta> coleccionUsuario;

    /**
     * Constructor de la clase MiTreeMap.
     * Inicializa las colecciones de cartas como TreeMap.
     */
    public MiTreeMap() {
        this.coleccionEntera = new TreeMap<>();
        this.coleccionUsuario = new TreeMap<>();
    }
        ...
        if (coleccionUsuario.isEmpty()) {
            ...
            for (Map.Entry<String, Carta> entry : coleccionUsuario.entrySet()) {
                if (entry.getValue().getTipo().equals("Monstruo")) {
                    System.out.println("- Nombre Carta: " + entry.getKey() + ", Tipo: " + entry.getValue().getTipo());
                    hayMonstruos = true;
                }
            }
            if (!hayMonstruos) {
